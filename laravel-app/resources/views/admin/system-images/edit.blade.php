...
@section('title', 'Modifier l\'Image Système')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Modifier l'Image Système</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.system-images.update', $image) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kernel_image_path') is-invalid @enderror" 
                                   id="kernel_image_path" name="kernel_image_path" 
                                   value="{{ old('kernel_image_path', $image->kernel_image_path) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('rootfs_path') is-invalid @enderror" 
                                   id="rootfs_path" name="rootfs_path" 
                                   value="{{ old('rootfs_path', $image->rootfs_path) }}" required>
