...
@section('title', 'Modifier l\'Offre VM')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Modifier l'Offre VM</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.vm-offers.update', $offer) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('vcpu_count') is-invalid @enderror" 
                                       id="vcpu_count" name="vcpu_count" value="{{ old('vcpu_count', $offer->vcpu_count) }}" required min="1">
                                @error('vcpu_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('memory_size_mib') is-invalid @enderror" 
                                       id="memory_size_mib" name="memory_size_mib" value="{{ old('memory_size_mib', $offer->memory_size_mib) }}" required min="128">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('disk_size_gb') is-invalid @enderror" 
                                       id="disk_size_gb" name="disk_size_gb" value="{{ old('disk_size_gb', $offer->disk_size_gb) }}" required min="1">
                                @error('disk_size_gb')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price_per_hour') is-invalid @enderror" 
                                   id="price_per_hour" name="price_per_hour" value="{{ old('price_per_hour', $offer->price_per_hour) }}" 
